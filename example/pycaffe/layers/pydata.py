...
class VeriDataLayer(caffe.Layer):
    ...
    def forward(self, bottom, top):
        ...
        self.data_split1, self.label_split1 = self.load_image(idx_batch1)
        self.data_split2, self.label_split2  = self.load_image(idx_batch2)
    ...
    def load_data(self, idx_batch):
        ...
        for idx in idx_batch:
            ...
            if self.crop:
                ...
                im = ImageOps.crop(im, (random.randint(w/8), random.randint(h/8), random.randint(w/8),
                                        random.randint(h/8)))
